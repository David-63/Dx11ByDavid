...
inline SimpleMath::Rectangle Rectangle::Intersect(const Rectangle& ra, const Rectangle& rb)
{
...
inline SimpleMath::Rectangle Rectangle::Union(const Rectangle& ra, const Rectangle& rb)
{
    long righta = ra.x + ra.width;
    long rightb = rb.x + rb.width;
